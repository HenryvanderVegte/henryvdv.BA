...
public class DocumentInfo_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.henryvdv.ba.DocumentInfo");
  ...
  public String getDocumentName(int addr) {
      ...
      jcas.throwFeatMissing("documentName", "de.unidue.henryvdv.ba.DocumentInfo");
